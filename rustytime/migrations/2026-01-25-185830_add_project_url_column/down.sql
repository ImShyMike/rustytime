-- Restore repo_url from project_url
UPDATE projects SET repo_url = project_url WHERE project_url IS NOT NULL;

-- Drop project_url column
ALTER TABLE projects DROP COLUMN project_url;

-- Revert list_projects_with_time to previous version
